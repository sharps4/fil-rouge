...
export default function App({navigation}) {
    ...
    useEffect(() => {
        if (ended) {navigation.navigate('Main');}
    }, [isFocused, ended]);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#033165' }}>
            <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
                <Animated.View style={{ transform: [{ scale: scale }]}}>
                    <Svg viewBox='0 0 300 300' width={200} height={200} fill="#fff">
            ...
            <Animated.View style={{ transform: [{ scale: scale }]}}>
                <View style={{
                    ...
                    <Paragraph size='lg'>By</Paragraph>
